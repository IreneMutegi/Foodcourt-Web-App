...
class MenuResource(Resource):
    ...
    def post(self, restaurant_id):
        ...
        # Retrieve the restaurant by the given restaurant_id
        restaurant = Restaurant.query.get(restaurant_id)
        if not restaurant:
            return {"error": "Restaurant not found"}, 404

        # Create a new menu item without specifying the id (it's auto-generated by SQLAlchemy)
    ...
    def patch(self, restaurant_id, meal_id):
        ...
        # Find the meal by its id and restaurant_id
    ...
    def get(self, restaurant_id):
        ...
        for order in orders:
            ...
            orders_list.append({
                ...
                "total": meal.price * quantity if meal else "Unknown Total",
                "status": status,
                "timestamp": timestamp_str  # Include the formatted timestamp here
            })
